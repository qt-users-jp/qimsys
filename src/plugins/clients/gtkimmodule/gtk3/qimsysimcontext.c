...
static void qimsys_im_context_focus_in(GtkIMContext *context)
{
    ...
    if (self->d->application_manager) {
        if (self->d->client_window) {
            qimsys_application_manager_set_window(self->d->application_manager, gdk_x11_window_get_xid(self->d->client_window));
            qimsys_application_manager_set_widget(self->d->application_manager, gdk_x11_window_get_xid(self->d->client_window));
        }
...
static void qimsys_im_context_set_client_window(GtkIMContext *context, GdkWindow *client_window)
{
    ...
    if (self->d->application_manager) {
        if (client_window) {
            qimsys_application_manager_set_window(self->d->application_manager, gdk_x11_window_get_xid(client_window));
            qimsys_application_manager_set_widget(self->d->application_manager, gdk_x11_window_get_xid(client_window));
        } else {
            qimsys_application_manager_set_window(self->d->application_manager, 0);
            qimsys_application_manager_set_widget(self->d->application_manager, 0);
        }
